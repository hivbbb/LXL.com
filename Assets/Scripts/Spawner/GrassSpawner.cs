...
public class GrassSpawner : MonoBehaviour
{
    ...
    public GameObject Grassresource1;
    public GameObject Grassresource2;
    public int Grass1count;
    public int Grass2count;
    ...
    void Start()
    {
        ...
        Randomresource(Grassresource1, Grass1count);
        Randomresource(Grassresource2, Grass2count);
